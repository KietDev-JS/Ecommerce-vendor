...
type BeforeAuthHandler = (req: NextRequest, evt: NextFetchEvent) => NextMiddlewareResult | Promise<NextMiddlewareResult> | false | Promise<false>;
type AfterAuthHandler = (auth: AuthObject & {
    isPublicRoute: boolean;
    isApiRoute: boolean;
}, req: NextRequest, evt: NextFetchEvent) => NextMiddlewareResult | Promise<NextMiddlewareResult>;
